...
<img src="man/figures/README-circular-1.png" width="100%" />
...
- `vignette("kodom-lines")` — full feature tour of `geom_kodom_line()`:
  point shapes, independent `size`/`linewidth`, covariate encoding,
  faceting
- `vignette("kodom-variants")` — `geom_kodom_heatmap()` and
  `geom_kodom_circular()` in depth: bin resolution, aggregation
  functions, gap/inner fractions, large-cohort use cases
